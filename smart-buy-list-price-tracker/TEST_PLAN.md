...
| **`tests/smart-buy-list-ui-components.test.js`**       | 4-tab SPA navigation (`Planning`, `Buy`, `Price History`, `Comparator`), touch gestures, item card pure event delegation (`handleItemCardDelegatedClick`), XSS immunity, dual-modal architecture, Smart Quick-Entry Omnibox NLP, case-insensitive item matching, responsive deal badges (mobile icon vs tablet icon+text). | `NAV-01..16`, `GESTURE-01..12`, `DIFF-01..08`, `CARD-01..14`, `ID-01..09`, `EDIT-01..06`, `SMART-00..07`, `PACE-01..03`, `RESP-BADGE-01..06`, `DEAL-TAB-01..05` |
