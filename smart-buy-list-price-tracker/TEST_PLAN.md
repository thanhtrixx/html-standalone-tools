# 🧪 Living Test Plan & Quality Assurance Strategy (v4.6.0)
...
| **`tests/smart-buy-list-storage-persistence.test.js`** | LocalStorage schema upgrades, `IndexedDBStorageProvider` object stores & transactions, PAT token migration safety, dynamic sample data ID isolation from tombstones, symmetric Settings 2x2 data management, and clipboard JSON interchange.                                                                                                                                                                                                                                                                                                                                                                                                                    | `STORE-01..08`, `IDB-01..06`, `SAMPLE-ID-01..04`, `BACKUP-01..04`, `CLIP-01..08`                                                                                                                                                                                                           |
| **`tests/smart-buy-list-cloud-sync.test.js`**          | Google Drive AppData REST v3, GitHub Gist REST sync, Gist URL regex extraction (`extractGistId`), anonymous public Gist downloads, 3-way differential merge (`Merge3`), 30-day deletion tombstones, calm cloud sync debounce (15s), and HTTP 403/429 rate limit diagnostics.                                                                                                                                                                                                                                                                                                                                                                                    | `SEAM-01..02`, `GIS-01..02`, `DRIVE-01..03`, `3WAY-01..05`, `TOMB-01..06`, `GIST-URL-01..06`, `GIST-01..03`, `SYNC-ICON-01..04`, `SYNC-ERR-01..06`                                                                                                                                         |
| **`tests/smart-buy-list-ui-components.test.js`**       | 4-tab SPA navigation (`Planning`, `Buy`, `Price History`, `Comparator`), touch gestures, item card pure event delegation (`handleItemCardDelegatedClick`), XSS immunity, dual-modal architecture, Smart Quick-Entry Omnibox NLP, case-insensitive item matching, responsive deal badges (mobile icon vs tablet icon+text), Buy Mode in-aisle normalized unit price & ATL delta, context-adaptive viewport & ambient pacing ticker, two-tier Planning card, unclipped overflow menu (`overflow-visible`), modal delete button (`#btnDeleteEditItem`), hollow unchecked checkboxes, 44px Price History bulk action touch targets, and Trip Victory Receipt modal. | `NAV-01..16`, `GESTURE-01..12`, `DIFF-01..08`, `CARD-01..14`, `ID-01..09`, `EDIT-01..06`, `SMART-00..07`, `PACE-01..03`, `RESP-BADGE-01..06`, `DEAL-TAB-01..05`, `BUY-UNIT-01..04`, `VIEWPORT-01..04`, `PLAN-CARD-01..04`, `VICTORY-01..04`, `CHECK-01..04`, `MENU-01..03`, `BTN-H-01..02` |
| **`tests/smart-buy-list-pwa-lifecycle.test.js`**       | Dynamic SemVer version parity invariant (`4.6.0`), service worker update flow, cache purge controls, URL state compression/share payloads, iOS safe-area insets, and two-tier native PWA back navigation hierarchy with root exit guard ("Press back again to exit" with 2000ms window).                                                                                                                                                                                                                                                                                                                                                                        | `VER-01..03`, `PWA-01..25`, `PWA-UPD-01..11`, `SHARE-01a..01j`, `IOS-01..14`, `SW-01..03`, `BACK-NAV-01..06`, `BACK-EXIT-01..06`                                                                                                                                                           |
| **`tests/smart-buy-list-i18n.test.js`**                | 100% dictionary key symmetry between English (`en`) and Vietnamese (`vi`), bilingual exit toasts and sync statuses, Vietnam-first defaults (`vi`, `VND`, default VN supermarket chains), currency formatting (`formatCurrency`), ARIA accessibility labels, and Trip Victory Receipt translations.                                                                                                                                                                                                                                                                                                                                                              | `I18N-01..03`, `I18N-PARITY-EN→VI`, `I18N-PARITY-VI→EN`, `VN-DEF-01..03`, `VN-FLAG-01`, `ARIA-01..06`, `VICTORY-I18N-01..02`                                                                                                                                                               |
