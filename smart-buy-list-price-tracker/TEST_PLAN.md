...
| **`tests/smart-buy-list-ui-components.test.js`**       | 4-tab SPA navigation (`Planning`, `Buy`, `Price History`, `Comparator`), touch gestures, item card pure event delegation (`handleItemCardDelegatedClick`), XSS immunity, dual-modal architecture, Smart Quick-Entry Omnibox NLP, case-insensitive item matching, responsive deal badges (mobile icon vs tablet icon+text), Buy Mode in-aisle normalized unit price & ATL delta, context-adaptive viewport & ambient pacing ticker, two-tier Planning card, and Trip Victory Receipt modal. | `NAV-01..16`, `GESTURE-01..12`, `DIFF-01..08`, `CARD-01..14`, `ID-01..09`, `EDIT-01..06`, `SMART-00..07`, `PACE-01..03`, `RESP-BADGE-01..06`, `DEAL-TAB-01..05`, `BUY-UNIT-01..04`, `VIEWPORT-01..04`, `PLAN-CARD-01..04`, `VICTORY-01..04` |
| **`tests/smart-buy-list-pwa-lifecycle.test.js`**       | Dynamic SemVer version parity invariant (`4.5.1`), service worker update flow, cache purge controls, URL state compression/share payloads, iOS safe-area insets, and two-tier native PWA back navigation hierarchy with root exit guard ("Press back again to exit" with 2000ms window).                                                                                                                                                                                                   | `VER-01..03`, `PWA-01..25`, `PWA-UPD-01..11`, `SHARE-01a..01j`, `IOS-01..14`, `SW-01..03`, `BACK-NAV-01..06`, `BACK-EXIT-01..06`                                                                                                            |
