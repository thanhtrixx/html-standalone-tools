# 📜 Habit Tracker — Historical Roadmap & Implemented Slices Archive

> **Archive Notice:** This document contains historical, completed vertical slices (ADR-0006 through ADR-0017) for the **Atomic Habit & Routine Tracker** (`habit-tracker`).  
> **Living Requirements & Active Roadmaps:** [`../ITEMS_TO_IMPLEMENT.md`](../../ITEMS_TO_IMPLEMENT.md)  
