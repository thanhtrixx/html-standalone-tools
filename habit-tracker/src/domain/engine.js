  ...
  const STARTER_KITS = [
    {
      ...
      habits: [
        {
          name: "Uống 500ml nước ấm / Morning Hydration",
          nameVi: "Uống 500ml nước ấm",
          nameEn: "Morning Hydration",
        ...
        {
          name: "Thiền định 10 phút / 10-Min Meditation",
          nameVi: "Thiền định 10 phút",
          nameEn: "10-Min Meditation",
        ...
        {
          name: "Giãn cơ & Khởi động / Morning Stretch",
          nameVi: "Giãn cơ & Khởi động",
        ...
        {
          name: "Lập kế hoạch ngày / Plan the Day",
          nameVi: "Lập kế hoạch ngày",
          nameEn: "Plan the Day",
          type: HABIT_TYPES.BINARY,
          targetValue: 1,
          routine: ROUTINES.MORNING,
    ...
    },
    {
      ...
      habits: [
        {
          name: "Khối tập trung sâu 45 phút / 45-Min Deep Work",
          nameVi: "Khối tập trung sâu 45 phút",
          nameEn: "45-Min Deep Work",
          type: HABIT_TYPES.TIMER,
          targetValue: 2700,
          unit: "mins",
          step: 60,
        ...
        {
          name: "Đọc 20 trang sách / Read 20 Pages",
          nameVi: "Đọc 20 trang sách",
          nameEn: "Read 20 Pages",
          type: HABIT_TYPES.NUMERIC,
          targetValue: 20,
          unit: "pages",
          step: 5,
        ...
        {
          name: "Không mạng xã hội giờ làm / Zero Social Media Block",
          nameVi: "Không mạng xã hội giờ làm",
          nameEn: "Zero Social Media Block",
          type: HABIT_TYPES.BINARY,
          targetValue: 1,
          routine: ROUTINES.AFTERNOON,
          routines: [ROUTINES.AFTERNOON],
    ...
    },
    {
      ...
      habits: [
        {
          name: "Uống đủ 2500ml nước / Daily Water 2500ml",
          nameVi: "Uống đủ 2500ml nước",
          nameEn: "Daily Water 2500ml",
          type: HABIT_TYPES.NUMERIC,
          targetValue: 2500,
          unit: "ml",
          step: 250,
          routine: ROUTINES.ANYTIME,
          routines: [ROUTINES.ANYTIME],
          domain: "health",
          color: "emerald",
          icon: "💧",
          scheduleType: SCHEDULE_TYPES.DAILY,
        ...
        {
          name: "Tập thể dục 30 phút / 30-Min Workout",
          nameVi: "Tập thể dục 30 phút",
        ...
        {
          name: "Ngủ trước 23:00 / Sleep Before 23:00",
          nameVi: "Ngủ trước 23:00",
          nameEn: "Sleep Before 23:00",
          type: HABIT_TYPES.BINARY,
          targetValue: 1,
          routine: ROUTINES.EVENING,
          routines: [ROUTINES.EVENING],
    ...
    },
    {
      ...
      habits: [
        {
          name: "Nhật ký biết ơn / Gratitude Journal",
          nameVi: "Nhật ký biết ơn",
        ...
        {
          name: "Đi bộ thư giãn 15 phút / 15-Min Nature Walk",
          nameVi: "Đi bộ thư giãn 15 phút",
          nameEn: "15-Min Nature Walk",
          type: HABIT_TYPES.TIMER,
          targetValue: 900,
          unit: "mins",
          step: 60,
        ...
        {
          name: "Tắt màn hình trước khi ngủ / Digital Sunset",
          nameVi: "Tắt màn hình trước khi ngủ",
    ...
    {
      id: "fitness-strength",
      titleKey: "starter_fitness_strength_title",
      descKey: "starter_fitness_strength_desc",
      domain: "health",
      icon: "💪",
      habits: [
        {
          name: "Tập luyện sức mạnh 45 phút / 45-Min Strength Training",
          nameVi: "Tập luyện sức mạnh 45 phút",
          nameEn: "45-Min Strength Training",
          type: HABIT_TYPES.TIMER,
          targetValue: 2700,
          unit: "mins",
          step: 60,
        ...
        {
          name: "Bổ sung 100g Protein / 100g Daily Protein",
          nameVi: "Bổ sung 100g Protein",
          nameEn: "100g Daily Protein",
          type: HABIT_TYPES.NUMERIC,
          targetValue: 100,
          unit: "g",
          step: 25,
        ...
        {
          name: "Đạt 10.000 bước chân / 10,000 Daily Steps",
          nameVi: "Đạt 10.000 bước chân",
          nameEn: "10,000 Daily Steps",
          type: HABIT_TYPES.NUMERIC,
          targetValue: 10000,
          unit: "steps",
          step: 1000,
    ...
    },
    {
      ...
      titleKey: "starter_lifelong_learning_title",
      descKey: "starter_lifelong_learning_desc",
      domain: "craft",
      icon: "💡",
      habits: [
        {
          name: "Luyện tập kỹ năng mới 30 phút / 30-Min Skill Practice",
          nameVi: "Luyện tập kỹ năng mới 30 phút",
          nameEn: "30-Min Skill Practice",
          type: HABIT_TYPES.TIMER,
          targetValue: 1800,
          unit: "mins",
          step: 60,
        ...
        {
          name: "Ghi chép & đúc kết kiến thức / Daily Flashcard & Note",
          nameVi: "Ghi chép & đúc kết kiến thức",
          nameEn: "Daily Flashcard & Note",
          type: HABIT_TYPES.BINARY,
          targetValue: 1,
          routine: ROUTINES.EVENING,
          routines: [ROUTINES.EVENING],
        ...
        {
          name: "Nghe 1 tập Podcast / 1 Educational Podcast",
          nameVi: "Nghe 1 tập Podcast",
          nameEn: "1 Educational Podcast",
          type: HABIT_TYPES.BINARY,
          targetValue: 1,
          routine: ROUTINES.AFTERNOON,
          routines: [ROUTINES.AFTERNOON],
    ...
    },
    {
      ...
      titleKey: "starter_financial_discipline_title",
      descKey: "starter_financial_discipline_desc",
      domain: "discipline",
      icon: "💰",
      habits: [
        {
          name: "Ghi chép chi tiêu hôm nay / Log Daily Expenses",
          nameVi: "Ghi chép chi tiêu hôm nay",
          nameEn: "Log Daily Expenses",
          type: HABIT_TYPES.BINARY,
          targetValue: 1,
          routine: ROUTINES.EVENING,
          routines: [ROUTINES.EVENING],
        ...
        {
          name: "Không mua sắm bốc đồng / Zero Impulse Buying",
          nameVi: "Không mua sắm bốc đồng",
          nameEn: "Zero Impulse Buying",
          type: HABIT_TYPES.BINARY,
          targetValue: 1,
          routine: ROUTINES.ANYTIME,
          routines: [ROUTINES.ANYTIME],
        ...
        {
          name: "Kiểm tra quỹ tài chính / Review Savings Goal",
          nameVi: "Kiểm tra quỹ tài chính",
          nameEn: "Review Savings Goal",
          type: HABIT_TYPES.BINARY,
          targetValue: 1,
          routine: ROUTINES.MORNING,
          routines: [ROUTINES.MORNING],
    ...
    {
      id: "sleep-recovery",
      titleKey: "starter_sleep_recovery_title",
      descKey: "starter_sleep_recovery_desc",
      domain: "health",
      icon: "🛌",
      habits: [
        {
          name: "Ngủ đủ 8 tiếng / 8-Hour Restful Sleep",
          nameVi: "Ngủ đủ 8 tiếng",
          nameEn: "8-Hour Restful Sleep",
          type: HABIT_TYPES.NUMERIC,
          targetValue: 8,
          unit: "hours",
          step: 1,
        ...
        {
          name: "Ngâm chân & thư giãn / Warm Foot Bath & Relax",
          nameVi: "Ngâm chân & thư giãn",
          nameEn: "Warm Foot Bath & Relax",
          type: HABIT_TYPES.BINARY,
          targetValue: 1,
          routine: ROUTINES.EVENING,
          routines: [ROUTINES.EVENING],
        ...
        {
          name: "Không caffeine sau 14:00 / Zero Caffeine after 2 PM",
          nameVi: "Không caffeine sau 14:00",
          nameEn: "Zero Caffeine after 2 PM",
          type: HABIT_TYPES.BINARY,
          targetValue: 1,
          routine: ROUTINES.AFTERNOON,
          routines: [ROUTINES.AFTERNOON],
