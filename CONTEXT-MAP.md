...
| **Atomic Habit & Routine Tracker**      | `Hardened Stable` | Mobile-first routine PWA, mathematical streaks/consistency models, 52-week heatmaps, offline IndexedDB persistence.          | [`CONTEXT.md`](./habit-tracker/CONTEXT.md)                      |
