...
| **R4**  | Salary Growth                    | Apply annual compound escalation to monthly salary on exact 12-month simulation anniversaries                                               | [`ADR-0001`](./docs/adr/0001-financial-simulation-engine-and-cashflow-rules.md)             | P0       |
...
| **R6**  | Withdrawals                      | Deduct scheduled one-time outflows from Flexible Pool with deficit logging and salary replenishment                                         | [`ADR-0001`](./docs/adr/0001-financial-simulation-engine-and-cashflow-rules.md)             | P1       |
| **R7**  | Goal Milestone Tracking          | Render goal progress bar, milestone achievement date badge, and animated ring chart                                                         | —                                                                                           | P1       |
| **R8**  | Resilient Shareable Link         | Encode state into URL hash using LZ-String compression with automatic decompression fallback                                                | [`ADR-0002`](./docs/adr/0002-state-serialization-url-compression-and-ai-dossier-engine.md)  | P1       |
| **R9**  | Theme Toggle                     | Seamless Light/Dark theme switching with class persistence on `<html>` and CSS color transitions                                            | [`ADR-0003`](./docs/adr/0003-ui-ux-architecture-theme-tokens-and-interaction-components.md) | P2       |
...
| **R14** | Monthly Heatmap Grid             | 12-column color-intensity calendar grid mapping monthly liquidity density and net wealth shifts                                             | [`ADR-0003`](./docs/adr/0003-ui-ux-architecture-theme-tokens-and-interaction-components.md) | P2       |
| **R15** | Tabbed Analytics Hub             | Consolidated tab switcher integrating Wealth Timeline, Heatmap Matrix, and Year-over-Year (YoY) breakdown                                   | [`ADR-0003`](./docs/adr/0003-ui-ux-architecture-theme-tokens-and-interaction-components.md) | P2       |
| **R16** | CSV Editor Modal                 | Full in-browser CRUD editor for portfolio accounts with date validation (`End Date >= Start Date`)                                          | —                                                                                           | P1       |
| **R17** | Scenario Comparison              | Dual-pass comparison workbench evaluating Scenario A baseline vs Scenario B with dynamic delta badges                                       | [`ADR-0001`](./docs/adr/0001-financial-simulation-engine-and-cashflow-rules.md)             | P2       |
...
| **R20** | Auto Term Allocation Rule        | Sweep excess pool liquidity into a consolidated $N$-month term deposit above threshold and emergency buffer                                 | [`ADR-0001`](./docs/adr/0001-financial-simulation-engine-and-cashflow-rules.md)             | P0       |
| **R21** | Bilingual Language Support       | Full Vietnamese & English localization (`TRANSLATIONS.en`/`vi`) with locale-standard numbers and dates                                      | [`ADR-0003`](./docs/adr/0003-ui-ux-architecture-theme-tokens-and-interaction-components.md) | P1       |
| **R22** | Annual Bonus & Cashflows         | Configurable annual bonus multiplier (e.g. 13th month salary) and recurring withdrawal schedule generator                                   | [`ADR-0001`](./docs/adr/0001-financial-simulation-engine-and-cashflow-rules.md)             | P1       |
| **R23** | Strategy Persona Presets         | One-click financial strategies (Fresh Grad, FIRE, Home Downpayment, Bank Ladder) with 5s undo safeguard                                     | [`ADR-0002`](./docs/adr/0002-state-serialization-url-compression-and-ai-dossier-engine.md)  | P1       |
| **R24** | Currency Masking & Verbal Labels | Live thousand-separator input masking (`.` in `vi`, `,` in `en`) and dynamic verbal quantity helpers                                        | [`ADR-0003`](./docs/adr/0003-ui-ux-architecture-theme-tokens-and-interaction-components.md) | P1       |
...
| **R26** | Continuous Multi-Year Heatmap    | Matrix rendering all simulation years with Net Inflow vs Total Wealth modes and popover breakdown tooltips                                  | [`ADR-0003`](./docs/adr/0003-ui-ux-architecture-theme-tokens-and-interaction-components.md) | P1       |
| **R27** | Full-Width Savings Accounts Hub  | Dedicated portfolio table with aggregated KPI pills and category filter tabs (`All`, `Active Fixed`, `Auto Term`, `Matured`, `Withdrawals`) | [`ADR-0003`](./docs/adr/0003-ui-ux-architecture-theme-tokens-and-interaction-components.md) | P1       |
| **R28** | Modal Layering & Safeguards      | Centralized modal lifecycle controller (`dismissAllModals()`), single-active-dialog invariant, and backdrop dismissals                      | [`ADR-0003`](./docs/adr/0003-ui-ux-architecture-theme-tokens-and-interaction-components.md) | P1       |
...
| **R30** | Comparative Negative Delta Badge | Dynamic badge styling for negative Scenario B performance and state-isolated toggle reset                                                   | [`ADR-0001`](./docs/adr/0001-financial-simulation-engine-and-cashflow-rules.md)             | P1       |
| **R31** | Synchronized Verbal Helpers      | Real-time bilingual verbal quantity sync across typing, preset chips, and language switching                                                | [`ADR-0003`](./docs/adr/0003-ui-ux-architecture-theme-tokens-and-interaction-components.md) | P1       |
| **R32** | Resilient URL State Sharing      | Percent-encoded character sanitation, dual-mode LZ-String/Base64 decompression, dynamic hashchange reactivity, and cross-context clipboard  | [`ADR-0002`](./docs/adr/0002-state-serialization-url-compression-and-ai-dossier-engine.md)  | P1       |
| **R33** | Semantic Token Theme System      | Centralized CSS custom properties in `:root` and `:root.light` with WCAG 2.1 AA/AAA contrast adherence                                      | [`ADR-0003`](./docs/adr/0003-ui-ux-architecture-theme-tokens-and-interaction-components.md) | P1       |
| **R34** | Dynamic Chart Theme Sync Hook    | Real-time synchronization of Chart.js gridlines, ticks, legends, and tooltips upon switching theme                                          | [`ADR-0003`](./docs/adr/0003-ui-ux-architecture-theme-tokens-and-interaction-components.md) | P1       |
| **R35** | Responsive Mobile Action Sheet   | Condensed overflow action menu for secondary actions on viewports $< 768\text{px}$                                                          | [`ADR-0003`](./docs/adr/0003-ui-ux-architecture-theme-tokens-and-interaction-components.md) | P1       |
| **R36** | Mobile Metric Grid & Carousels   | 2x2 compact metric cards and horizontally scrollable touch preset carousels ($\ge 36\text{px}$ touch targets)                               | [`ADR-0003`](./docs/adr/0003-ui-ux-architecture-theme-tokens-and-interaction-components.md) | P1       |
| **R37** | Adaptive Mobile Card View        | Viewport-triggered transformation of wide portfolio table into structured mobile touch cards on $< 640\text{px}$                            | [`ADR-0003`](./docs/adr/0003-ui-ux-architecture-theme-tokens-and-interaction-components.md) | P1       |
| **R38** | Light Theme Contrast Overrides   | Explicit high-contrast CSS overrides for slate surfaces, timeframe buttons, and badge chips in Light mode                                   | [`ADR-0003`](./docs/adr/0003-ui-ux-architecture-theme-tokens-and-interaction-components.md) | P1       |
| **R39** | AI Financial Health Dossier      | Standalone client-side Markdown dossier generator modal with monospaced preview, 1-click clipboard copy, and `.md` file download            | [`ADR-0002`](./docs/adr/0002-state-serialization-url-compression-and-ai-dossier-engine.md)  | P1       |
| **R40** | AI Blueprints & Privacy Mask     | 5 tailored advisory prompt blueprints, custom inquiry notes, and zero-leak privacy mask (salary multiples & % shares)                       | [`ADR-0002`](./docs/adr/0002-state-serialization-url-compression-and-ai-dossier-engine.md)  | P1       |
| **R41** | Interactive Tooltip Engine       | Floating popover engine with instant hover, touch toggle isolation from labels, keyboard accessibility, and 100% parameter/KPI coverage     | [`ADR-0003`](./docs/adr/0003-ui-ux-architecture-theme-tokens-and-interaction-components.md) | P1       |
